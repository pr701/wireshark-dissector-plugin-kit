...
WS_DLL_PLUGIN const gchar plugin_version[] = VERSION;
WS_DLL_PLUGIN const int plugin_want_major = WIRESHARK_VERSION_MAJOR;
WS_DLL_PLUGIN const int plugin_want_minor = WIRESHARK_VERSION_MINOR;

WS_DLL_PLUGIN void plugin_register(void);
...
static int
dissect_hello(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data)
{
