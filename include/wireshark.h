...
#ifndef __WIRESHARK_DISSECTOR_H__
#define __WIRESHARK_DISSECTOR_H__

#include <stdint.h>
#include <time.h>

/* Export / import */
#if defined(__GNUC__) && (defined(__APPLE__) || defined(__unix__))
	#define WS_DLL_API_DEF		__attribute__ ((__visibility__("default")))
	#define WS_DLL_PLUGIN_DEF	WS_DLL_API_DEF

	#ifndef G_GNUC_PRINTF
		#define G_GNUC_PRINTF(format_idx, arg_idx)	__attribute__((__format__ (__printf__, format_idx, arg_idx)))
	#endif
#elif defined(_MSC_VER)
	#define WS_DLL_API_DEF		__declspec(dllimport)
	#define WS_DLL_PLUGIN_DEF	__declspec(dllexport)

	#define G_GNUC_PRINTF(format_idx, arg_idx)

	#pragma comment(lib, "libwireshark")
#endif

#define WS_DLL_API		WS_DLL_API_DEF		extern
#define WS_DLL_PLUGIN	WS_DLL_PLUGIN_DEF	extern
...
WS_DLL_API void proto_register_plugin(const proto_plugin* plugin);
...
WS_DLL_API dissector_handle_t create_dissector_handle(dissector_t dissector,
	const int proto);

WS_DLL_API dissector_handle_t create_dissector_handle_with_name(
...
WS_DLL_API dissector_handle_t new_create_dissector_handle(dissector_t dissector,
					       const int proto);

/* Add an entry to a uint dissector table. */
WS_DLL_API void dissector_add_uint(const char *abbrev, const guint32 pattern,
			dissector_handle_t handle);

/* Add an range of entries to a uint dissector table. */
WS_DLL_API void dissector_add_uint_range(const char *abbrev, struct epan_range *range,
    dissector_handle_t handle);
/* Delete the entry for a dissector in a uint dissector table
   with a particular pattern. */
WS_DLL_API void dissector_delete_uint(const char *name, const guint32 pattern,
			   dissector_handle_t handle);

/* Delete an range of entries from a uint dissector table. */
WS_DLL_API void dissector_delete_uint_range(const char *abbrev, struct epan_range *range,
    dissector_handle_t handle);
...
WS_DLL_API range_t *range_empty(void);
 ...
 */
WS_DLL_API convert_ret_t range_convert_str(range_t **range, const gchar *es,
    guint32 max_value);
 ...
 */
WS_DLL_API gboolean value_is_in_range(range_t *range, guint32 val);
 ...
 * @return TRUE if the value is in range
 */
WS_DLL_API gboolean ranges_are_equal(range_t *a, range_t *b);
 ...
 */
WS_DLL_API void range_foreach(range_t *range, void (*callback)(guint32 val));

/**
 * This function converts a range_t to a (ep_alloc()-allocated) string.
 */
WS_DLL_API char *range_convert_range(range_t *range);
 ...
 */
WS_DLL_API range_t *range_copy(range_t *src);
/*
 ...
 */
WS_DLL_API module_t *prefs_register_protocol(int id, void (*apply_cb)(void));

/*
 * Register a preference with an unsigned integral value.
 */
WS_DLL_API void prefs_register_uint_preference(module_t *module, const char *name,
				    const char *title, const char *description,
				    guint base, guint *var);
/*
 * Register a preference with a ranged value.
 */
WS_DLL_API void prefs_register_range_preference(module_t *module, const char *name,
...
WS_DLL_API proto_tree* proto_item_add_subtree(proto_item *ti, const gint idx);
...
WS_DLL_API guint tvb_captured_length(const tvbuff_t *tvb);

/* Get reported length of buffer */
WS_DLL_API guint tvb_reported_length(const tvbuff_t *tvb);

/************** START OF ACCESSORS ****************/
/* All accessors will throw an exception if appropriate */

WS_DLL_API guint8 tvb_get_guint8(tvbuff_t *tvb, const gint offset);

WS_DLL_API guint16 tvb_get_ntohs(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint32 tvb_get_ntoh24(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint32 tvb_get_ntohl(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_ntoh40(tvbuff_t *tvb, const gint offset);
WS_DLL_API gint64 tvb_get_ntohi40(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_ntoh48(tvbuff_t *tvb, const gint offset);
WS_DLL_API gint64 tvb_get_ntohi48(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_ntoh56(tvbuff_t *tvb, const gint offset);
WS_DLL_API gint64 tvb_get_ntohi56(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_ntoh64(tvbuff_t *tvb, const gint offset);
WS_DLL_API gfloat tvb_get_ntohieee_float(tvbuff_t *tvb, const gint offset);
WS_DLL_API gdouble tvb_get_ntohieee_double(tvbuff_t *tvb,
    const gint offset);

WS_DLL_API guint16 tvb_get_letohs(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint32 tvb_get_letoh24(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint32 tvb_get_letohl(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_letoh40(tvbuff_t *tvb, const gint offset);
WS_DLL_API gint64 tvb_get_letohi40(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_letoh48(tvbuff_t *tvb, const gint offset);
WS_DLL_API gint64 tvb_get_letohi48(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_letoh56(tvbuff_t *tvb, const gint offset);
WS_DLL_API gint64 tvb_get_letohi56(tvbuff_t *tvb, const gint offset);
WS_DLL_API guint64 tvb_get_letoh64(tvbuff_t *tvb, const gint offset);
WS_DLL_API gfloat tvb_get_letohieee_float(tvbuff_t *tvb, const gint offset);
WS_DLL_API gdouble tvb_get_letohieee_double(tvbuff_t *tvb,
    const gint offset);
 ...
 */
WS_DLL_API guint tvb_strsize(tvbuff_t *tvb, const gint offset);
 ...
 */
WS_DLL_API const guint8 *tvb_get_const_stringz(tvbuff_t *tvb,
 ...
 */
WS_DLL_API void	col_add_str(column_info *cinfo, const gint col, const gchar *str);
 ...
 */
WS_DLL_API void col_add_fstr(column_info *cinfo, const gint col, const gchar *format, ...);
 ...
 * @param col the column to use, e.g. COL_INFO
 */
WS_DLL_API void	col_set_fence(column_info *cinfo, const gint col);
 ...
 * @param col the column to use, e.g. COL_INFO
 */
WS_DLL_API void	col_clear(column_info *cinfo, const gint col);
 ...
 */
WS_DLL_API void	col_set_str(column_info *cinfo, const gint col, const gchar * str);

#endif /* __WIRESHARK_DISSECTOR_H__ */
